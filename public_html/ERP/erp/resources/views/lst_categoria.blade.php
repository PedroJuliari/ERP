...
<div class="rows">	
                ...
                <div class="caixa">
                    <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
						<span class="d-flex center-middle"><i class="far fa-list-alt mr-1"></i> Categorias</span>
						<div>
							<a href="{{url('categoria/create')}}" class="btn btn-verde mx-1 d-inline-block"><i class="fas fa-plus-circle"></i> Adicionar novo</a>
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                            <thead>
                                    <tr>
                                       ...
                                       <th align="center" width="50%">Categoria</th>
                            ...
                            @foreach($dados as $dado)                                    
                             <tr>
                                ...
                                <td align="left">{{$dado->categoria}}</td>
								<td align="center"><span class="text-verde"><i class="fas fa-check"></i> Sim</span></td>
                                											
                                <td align="center"><a href="{{url("categoria/$dado->id/edit")}}" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Editar</a>                              </td>									
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="{{url("categoria/$dado->id")}}" method="post">
        @csrf 
        @method('delete')
