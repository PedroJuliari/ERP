...
<a href="{{route('Deletar',$dado->id)}}"class ="btn btn-success" id="edita" >Excluir</a>
...
<div class="modal fade" id="Deletar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      <form action="{{url('usuarios',@$id3->id)}}"class="form-control" method="post">
      @csrf
      @method('DELETE')
      ...
      <div class="modal-body">
        Deseja Mesmo deletar o {{@$id3->nome}}?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
