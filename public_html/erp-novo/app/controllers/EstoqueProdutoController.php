...
public function __construct(){
   ...
   public function filtro(){
	 ...
	 $pesquisa->categoria = isset($_GET["categoria"])? strip_tags(filter_input(INPUT_GET,"categoria")):NULL;
	 $pesquisa->unidade =  isset($_GET["unidade"])? strip_tags(filter_input(INPUT_GET,"unidade")):NULL;
