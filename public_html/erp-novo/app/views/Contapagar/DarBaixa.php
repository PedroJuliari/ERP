...
<div class="conteudo-fluido">	
   <form action="<?php echo URL_BASE ."parcelapagar/baixar" ?>" method="post">
    <div class="rows">	
        <div class="col-12">
            <div class="col-12">
            <div class="caixa">
        ...
        <div class="col-12">
            <div class="caixa">
            <span class="h5 caixa-titulo"><i class="far fa-list-alt"></i> Dados do Pagamento: Parcela <?php echo $parcela->num_parcela . "/" . $contapagar->qtde_parcela ?></span>
            ...
            <input type="hidden"  name="id_parcela_pagar" value="<?php echo $parcela->id_parcela_pagar?> " class="btn btn-verde btn-grande d-inline-block">
            <input type="hidden"  name="id_conta_pagar" value="<?php echo $contapagar->id_conta_pagar?> " class="btn btn-verde btn-grande d-inline-block">
