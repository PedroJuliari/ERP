    ...
    <div class="col-12">
            ...
            <div class="caixa-titulo py-1 d-inline-block width-100">
					...
					<?php if($ordem->id_status_ordem_compra==1){ ?>
                                            <a href="<?php echo URL_BASE ."entradaordem/atender/" . $ordem->id_ordem_compra ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Atender</a>
                                        <?php }else{ ?>					 
