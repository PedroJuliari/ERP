                ...
                <form action="<?php echo URL_BASE ."cotacao/inserirSolicitacao" ?>" method="post" >
                    ...
                    <div class="rows">
                       ...
                       <select class="form-campo" name="id_solicitacao" id="id_solicitacao">
                            ...
                            <?php foreach($abertas as $solicitacao){
                                       ...
                                       <?php foreach ($solicitacoes as $solicitacao){ ?>
                                        <tr>
                                            ...
                                            <td align="left">
                                                ...
                                                <small class="datas">Data: <?php echo $solicitacao->data_solicitacao ?></small>
                                                <small class="datas">Data entrega: <?php echo $solicitacao->data_entrega ?></small>

                                            </td>
                                                  <td align="center"><?php echo $solicitacao->status_solicitacao ?></td>
                                                  <td align="center"><?php echo $solicitacao->qtde ?></td>
                                                <td align="center"><a href="<?php echo URL_BASE ."cotacao/excluirSocilicitacaoCotacao/" .$solicitacao->id_solicitacao_cotacao ."/".$solicitacao->id_solicitacao ?>"  class="link-vermelho"><i class="fas fa-trash-alt h5 mb-0"></i><!-- Excluir--></a>
                                                 </td>
                            ...
                            <div class="tabela-responsiva sm tborder">
                                    ...
                                    <?php 
                                        ...
                                        <tr class="status-bg"> 
                                            ...
                                            <td align="center"><a href="<?php echo URL_BASE ."cotacao/excluirFornecedorCotacao/" .$fornecedor->id_fornecedor_cotacao  ?>"  class="link-vermelho"><i class="fas fa-trash-alt h5 mb-0"></i></a> </td>									 
