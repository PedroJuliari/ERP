...
<div class="conteudo-fluido">						
			...
			<form name="busca" action="<?php echo URL_BASE ."solicitacao/filtro" ?>" method="GET" >
				 ...
				 <div class="col-3">
						...
						<?php foreach ($status as $s) {
                                                    $selecionado = (!isset($pesquisa)) ? "" : ($s->id_status_solicitacao==$pesquisa->idStatus) ? "selected" : "";
	...
	<form action="<?php echo URL_BASE ."cotacao/create" ?> " method="post">						
            ...
            <div class="caixa-titulo py-1 d-inline-block width-100">
                    <span class="h5  mb-0 pt-1 d-inline-block"><i class="far fa-list-alt"></i> Solicitações </span> <small class="d-inline-block text-right mb-0 h6 px-2"><b class="text-azul"><?php echo isset($total) ? $total : "0" ?></b> registros</small>
