...
<div class="col-12">
    <div class="caixa">
                    <div class="caixa-titulo py-1 d-inline-block width-100">
                                    <span class="h5 mb-0 d-inline-block"><i class="far fa-arrow-alt-circle-right"></i> Excluir acao</span>							
            ...
            <div class="col-6 d-block m-auto rows px-5 mt-5">
                <div class="col-12 mb-3">
                    <label class="text-label">Nome acao</label>	
                ...
                <div class="col-12 mt-3 mb-5">
                    <a href="<?php echo URL_BASE ."acao/excluir/". $acao->id_acao ?>" class="btn btn-azul d-block m-auto">Excluir acao</a>
