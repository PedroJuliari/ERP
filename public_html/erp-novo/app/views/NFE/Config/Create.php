<div class="conteudo-dividido bg-fundo">
		<form action="<?php echo URL_BASE ."configerp/salvar" ?>" method="Post"  >	
                        ...
                        <div id="tab-1" class="tab-content current">
                                ...
                                <div class="rows pb-4">
                                                ...
                                                <div class="col-1 mb-3">
                                                        ...
                                                        <input type="text" name="serie" value="<?php echo $config->nfe_serie ?>" placeholder="Digite aqui..." class="form-campo">
                                                </div>
                                                <div class="col-3 mb-3">
                                                        <label class="text-label">Certificado</label>	
                                                        <input type="text" name="certificado" value="<?php echo $config->nfe_certificado ?>"  placeholder="Digite aqui..." class="form-campo">
                                                </div>                                                	

                                                
                                                <div class="col-3 mb-3">
                                                        <label class="text-label">Senha Certificado</label>	
                                                        <input type="password" name="senha" value="<?php echo $config->nfe_senha ?>" placeholder="Digite aqui..." class="form-campo">
                                                </div>
                                              
                                                <div class="col-2 mb-3">
                                                        <label class="text-label">Versão:</label>	
                                                        <input type="text" name="versao" value="<?php echo $config->nfe_versao ?>" placeholder="Digite aqui..." class="form-campo">
                                                </div>
