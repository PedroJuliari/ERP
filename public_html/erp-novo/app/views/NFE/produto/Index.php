...
<div class="conteudo-fluido">						
    ...
    <div class="col-12">
            ...
            <div class="caixa-titulo py-1 d-inline-block width-100">
                    ...
                    <a href="<?php echo URL_BASE ."nfeproduto/create" ?>" class="btn btn-verde float-right"><i class="fas fa-plus-circle mb-0"></i> Adicionar novo</a>
            </div>	
                    ...
                    <table cellpadding="0" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                         ...
                                         <td align="center">
					<a href="<?php echo URL_BASE ."nfeproduto/editar/" .$produto->id_produto ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Editar</a>
                                         <a href="<?php echo URL_BASE ."nfeproduto/delete/" .$produto->id_produto ?>" class="d-inline-block btn btn-outline-vermelho btn-pequeno"><i class="fas fa-trash-alt"></i> Excluir</a>
                                         </td>
                                 </tr>												
                                <?php } ?>
