        ...
        <div id="tab-1" class="tab-content current">
                ...
                <div class="rows pb-4">
                        <div class="col-2 mb-3">
                                ...
                                <input type="text" name="cNF" value="<?php echo $proximoNfe ?>" readonly="true" placeholder="Digite aqui..." class="form-campo">
                        </div>
                        <div class="col-1 mb-3">
                                <label class="text-label">Pedido </label>	
                                <input type="text" name="id_pedido" value="<?php echo ($pedido) ? $pedido->id_pedido: NULL ?>" readonly="true" placeholder="Digite aqui..." class="form-campo">
                        </div>
                        ...
                        <div class="col-6 mb-3">
                               ...
                               <select class="form-campo" name="natOp" id="natOp" >
                                ...
                                <div class="col-1 mb-3">
                                        ...
                                        <input type="text" name="serie" value="<?php echo $config->nfe_serie ?>" readonly="true" placeholder="Digite aqui..." class="form-campo">
                                </div>
                                 <div class="col-2 mb-3">
                                    <label class="text-label">UF</label>	
                                     <input type="text" name="cUf" value="<?php echo $empresa->codigo_estado ?>" readonly="true" readonly="true" placeholder="Digite aqui..." class="form-campo">
                                    
                                </div>
                                <div class="col-3 mb-3">
                                        <label class="text-label">Data Emissão NF</label>	
                                        <input type="date" name="data_emissao_nfe" value="<?php echo date("Y-m-d") ?>" placeholder="Digite aqui..." class="form-campo">
                                </div>
                                <div class="col-2 mb-3">
                                        <label class="text-label">Hora emissão NF</label>	
                                        <input type="time" name="hora_emissao_nfe" value="<?php echo date("H:i:s") ?>" placeholder="Digite aqui..." class="form-campo">
                                </div>                             
                    
                                <div class="col-3 mb-3">
                                        <label class="text-label">Data saída/entrada</label>	
                                        <input type="date" name="data_saida_nfe" value="<?php echo date("Y-m-d") ?>" placeholder="Digite aqui..." class="form-campo">
                                </div> 
                                <div class="col-2 mb-3">
                                        <label class="text-label">Hora saída/entrada</label>	
                                        <input type="time" name="hora_saida_nfe" value="<?php echo date("H:i:s") ?>" placeholder="Digite aqui..." class="form-campo">
                                </div>
                    
                                <div class="col-3 mb-3">
                                    <label class="text-label">Ambiente</label>	
                                    <select class="form-campo" name="tpAmb">
                                        <option value="1" <?php echo ($config->nfe_ambiente=="1") ? "selected": "" ?> >Produção</option>
                                        <option value="2" <?php echo ($config->nfe_ambiente=="2") ? "selected": "" ?>>Homologação</option>                                                 
                            ...
                            <table cellpadding="0" cellspacing="0">
                                    <thead>
                                            <tr>
                                                    ...
                                                    <th align="left" width="250">Produto</th>
                                    ...
                                    <tbody>
                                        <?php foreach($itens as $item) { ?>
                                            <tr>
                                                    ...
                                                    <td align="center">R$ <?php echo $item->qtde * $item->valor ?></td>		
                                        ...
                                        <?php } ?>
                                            <tr>
                                                <td colspan="11" align="right"><b>Total R$</b> <span class="text-verde minimo-font"><?php echo moedaBr($pedido->total) ?></span></td>
                                            </tr>	
                                    </tbody>
                            </table>
