...
<div class="conteudo-fluido">						
    ...
    <div class="col-12">
            ...
            <div class="caixa-titulo py-1 d-inline-block width-100">
                    <span class="h5  mb-0 pt-1 d-inline-block"><i class="far fa-list-alt"></i>Histórico dos Lançamentos</span> <small class="d-inline-block text-right mb-0 h6 px-2"><b class="text-azul"><?php echo $total ?></b> registros</small>
                    ...
                    <table cellpadding="0" cellspacing="0">
                            ...
                            <tbody>
                                <?php foreach($fluxos as $historico){ ?>
                            					
                                <tr>
                                         <td align="center"><?php echo $historico->id_caixa_fluxo ?></td>
                                         <td align="center"><?php echo databr($historico->data_caixa,0) ?></td>
                                         <td align="center"><?php echo moedaBr($historico->valor_caixa) ?></td>
                                         <td align="center"><?php echo $historico->entrada_saida ?></td>
                                         <td align="center"><?php echo $historico->descricao_fluxo ?></td>
