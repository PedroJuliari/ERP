            ...
            <div class="col-6 d-block m-auto rows px-5 mt-5">
                ...
                <div class="col-12 mb-3">
                        <label class="text-label">Abrev</label>	
                          <input type="text" name="abrev" value="<?php echo isset($unidade) ? $unidade->abrev : null ?>" class="form-campo" placeholder="Digite o nome da sigla">
             
                     
                </div>                                    
                <div class="col-12 mt-3 mb-5">
                    <a href="<?php echo URL_BASE ."unidade/excluir/". $unidade->id_unidade ?>" class="btn btn-azul d-block m-auto">Excluir Categoria</a>
