                    ...
                    <table cellpadding="0" cellspacing="0">
                            ...
                            <?php foreach($ordens as $ordem){ ?>					
                                <tr>
                                         ...
                                         <td align="center">                                          				 
					    <a href="<?php echo URL_BASE ."financeiro/verOrdemCompra/" . $ordem->id_ordem_compra ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Autorizar</a>
