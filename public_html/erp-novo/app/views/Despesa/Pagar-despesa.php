            ...
            <span class="h5 caixa-titulo"><i class="fas fa-search"></i> Inserir Despesas</span>
                <form name="busca" action="<?php echo URL_BASE ."despesa/filtro" ?>" method="GET" >
                    <div class="rows p-3">
                        ...
                        <div class="col-3 mb-3">
                            <label class="text-label">Valor Pagto</label>	
                            <input type="text" name="valor_pagto" value="<?php echo isset($despesa) ? $despesa->valor_previsto : null ?>" class="form-campo" placeholder="Digite o nome da banco">
                        </div>
