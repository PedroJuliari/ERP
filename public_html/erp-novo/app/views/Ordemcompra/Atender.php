            ...
            <div class="col-12">
                    ...
                    <div class="tabela-responsiva">
                     ...
                     <div class="caixa">
                        ...
                        <a href="<?php echo URL_BASE ."ordemcompra/recusar/" . $pedido->id_pedido ?>" class="btn btn-amarelo btn-medio d-inline-block">Recusar</a>
                        <a href="<?php echo URL_BASE ."saida/excluir/" . $pedido->id_pedido ?>" class="btn btn-vermelho btn-medio d-inline-block">Excluir</a>
                       <!-- <a href="<?php echo URL_BASE ."ordemcompra/aprovar/" . $ordemcompra->id_ordem_compra ?>" class="btn btn-verde btn-medio d-inline-block">Aprovar Ordem de Compra</a>-->
                        
                        <input type="hidden" value="<?php echo $ordemcompra->id_ordem_compra ?>" name="id_ordem" />
