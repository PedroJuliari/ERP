...
<div class="conteudo-fluido">						
    ...
    <div class="rows">	
			...
			<form name="busca" action="<?php echo URL_BASE ."entradaordem/filtro" ?>" method="GET" >
                            <div class="rows p-3">
                                 <div class="col-3">
    ...
    <div class="col-12">
            ...
            <div class="caixa-titulo py-1 d-inline-block width-100">
                    <span class="h5  mb-0 pt-1 d-inline-block"><i class="far fa-list-alt"></i> Ordens de Compra </span> <small class="d-inline-block text-right mb-0 h6 px-2"><b class="text-azul"><?php echo isset($total) ? $total : "0" ?></b> registros</small>
                   <a href="<?php echo URL_BASE ."ordemcompra/create" ?>" class="btn btn-verde float-right"><i class="fas fa-plus-circle mb-0"></i> Adicionar novo</a>
            </div>	
                    ...
                    <table cellpadding="0" cellspacing="0">
                            ...
                            foreach($ordens as $ordem){ ?>					
                                <tr>
                                         ...
                                         <td align="center"><?php echo $ordem->data_emissao ?></td>
					...
					<?php if($ordem->id_status_ordem_compra==1){ ?>
                                            <a href="<?php echo URL_BASE ."ordemcompra/atender/" . $ordem->id_ordem_compra ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Aprovar</a>
                                        <?php }else{ ?>					 
					        <a href="<?php echo URL_BASE ."entradaordem/detalhes/" . $ordem->id_ordem_compra ?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Detalhes</a>
                                        <?php } ?>				
                                         </td>
                                 </tr>												
                            <?php } } ?>   
