            ...
            <div class="col-3 mb-2">
					...
					<option value="" selected>Selecione</option>
                        <?php foreach($estados as $estado){ 
						    $idEstado    =   isset($id_estado)?$id_estado : $contato->id_estado;
                            $selecionado = (!isset($contato)) ? "" : ($estado->id_estado==$contato->id_estado) ? "selected" : "";
            ...
            <div class="col-4 mb-2">
                    ...
                    <select class="form-campo" name="id_cidade" id="id_cidade">
                        <?php foreach($cidades as $cidade){
                            $selecionado = (!isset($contato)) ? "" : ($cidade->id_cidade==$contato->id_cidade) ? "selected" : "";
