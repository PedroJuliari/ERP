<?php
	function mostraPaginacao($url, $ordem, $lpp, $total){
		...
		if($ordem ==0){
			...
			<a href=$url_mais class=btn editar>Próxima</a> | 
			<a href=$url&ordem=$paginas class=btn editar>Última</a></div>";				
		}
		if($ordem > 0){
			$mais = $ordem+1;
			$url_mais = "$url&ordem=$mais";
			...
			$paginacao="<div><p>Página $mais de $paginas_mostradas</p><br>
			<a href=$url&ordem=0 class=btn editar>Primeira</a> | 
			<a href=$url_menos class=btn editar>Anterior</a> | 
			<a href=$url_mais class=btn editar>Próximo</a> | 
			<a href=$url&ordem=$paginas class=btn editar>Última</a></div>";				
		}
		if($ordem ==$paginas){
			$menos = $ordem - 1;
			...
			$paginacao="<div><p>Página $mais de $paginas_mostradas</p><br>
			<a href=$url&ordem=0 class=btn editar>Primeira</a> |				
			<a href=$url_menos class=btn editar>Anterior</a>  </div>";
		}
		if($paginas <=0 ){					
